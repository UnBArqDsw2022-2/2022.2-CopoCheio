...
<!-- HEADER -->
 ...
 <tr>
    <td rowspan="4">E01 - Sessão de Usuário Administrador</td>
    <td rowspan="2">F01 - Acessar conta</td>
 ...
 <tr>
  ...
  <tr>
    ...
    <td>US03 - Eu, como usuário administrador, gostaria de autenticar com login e senha, para que eu possa acessar minha conta</td>
    <td>M</td>
    <td>XX</td>
 </tr>
  ...
  <tr>
    ...
    <td>US04 - Eu, como usuário administrador, gostaria de efetuar logout, para que possa sair da minha conta</td>
    <td>M</td>
    <td>XX</td>
 </tr>
 ...
 <tr>
    ...
    <td rowspan="2">F04 - Pesquisar bebida</td>
    <td>US05 - Eu, como usuário administrador, gostaria de pesquisar alguma bebida da plataforma, para que posso acessar todas suas informações</td>
    <td>M</td>
    <td>XX</td>
 </tr>

 <tr>
    <td>US06 - Eu, como usuário administrador, gostaria de buscar alguma bebida por categoria, para que eu possa facilitar minha consulta por reeceita</td>
    <td>S</td>
    <td>XX</td>
 </tr>
  ...
  <tr>
    ...
    <td rowspan="2">F05 - Gerenciar bebidas</td>
  ...
  <tr>
    <td>US08 - Eu, como administrador, gostaria de aprovar, reprovar ou editar bebidas submetidas, para que possa ter receitas para usuários na plataforma</td>
    <td>M</td>
    <td>XX</td>
 </tr>
  ...
  <tr>
    ...
    <td>US09 - Eu, como administrador, gostaria de restringir usuários, para que possa tirar de circulação do site, usuários que fogem dos termos de serviço</td>
    <td>C</td>
    <td>XX</td>
 </tr>

 <tr>
    <td>US10 - Eu, como administrador, gostaria de procurar por um usuário pelo admin, para que possa ver sua informações e detalhes de comportamento na plataforma </td>
    <td>M</td>
    <td>XX</td>
 </tr>
  ...
  <tr>
    ...
    <td>US12 - Eu, como administrador, desejo criar uma receita de bebida a partir do admin</td>
    <td>M</td>
    <td>XX</td>
 </tr>

  <tr>
    <td>US13 - Eu, como administrador, desejo editar as informações de bebidas cadastradas</td>
    <td>M</td>
    <td>XX</td>
 </tr>

  <tr>
    <td>US14 - Eu, como administrador, desejo deletar uma bebida cadastrada a fim de remover conteúdo impróprio da plataforma</td>
    <td>M</td>
    <td>XX</td>
 </tr>
 ...
 <tr>
    ...
    <td>US15 - Eu, como administrador, gostaria de aprovar ou reprovar bebidas submetidas, para que possa ter receitas para usuários na plataforma</td>
    <td>M</td>
    <td>XX</td>
 </tr>

 <tr>
    <td>US16 - Eu, como administrador, gostaria de editar informações da bebida submetida, para que possa ter receitas condizentes na plataforma</td>
    <td>M</td>
    <td>XX</td>
 </tr>
