...
<!-- HEADER -->
 ...
 <tr>
  ...
  <tr>
    ...
    <td>US12 - Eu, como usuário, desejo poder curtir uma bebida, para ajudar a realçá-la na plataforma</td>
    <td>S</td>
    <td>XX</td>
 </tr>

  <tr>
    <td>US13 - Eu, como usuário, desejo poder favoritar uma bebida, para poder encontrá-la mais rapidamente no futuro</td>
    <td>S</td>
    <td>XX</td>
  </tr>

  <tr>
    <td>US14 - Eu, como usuário, desejo poder denunciar uma bebida, para alertar a plataforma de uma possível ofensa nas informações da bebida</td>
    <td>M</td>
    <td>XX</td>
  </tr>
  ...
  <tr>
    ...
    <td>US15 - Eu, como usuário, desejo sortear uma bebida aleatória, para encontrar receitas sem procurá-las</td>
    <td>M</td>
    <td>XX</td>
 </tr>

  <tr>
    <td>US16 - Eu, como usuário, desejo filtrar o sorteio de uma bebida, para limitar os possíveis resutados</td>
    <td>S</td>
    <td>XX</td>
  </tr>
  ...
  <tr>
    ...
    <td>US17 - Eu, como usuário, desejo submeter uma receita de bebida para a plataforma, a fim de ter minhas receitas publicadas no site</td>
    <td>M</td>
    <td>XX</td>
 </tr>
</table>
