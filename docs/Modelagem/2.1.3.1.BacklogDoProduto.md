...
<!-- HEADER -->
 ...
 <tr>
  ...
  <tr>
    <td rowspan="6">E02 - Comentários</td>
    <td rowspan="4">F04 - Manter comentários</td>
    <td>US08 - Eu, como usuário, desejo cadastrar um comentário á repeito de alguma bebida, a fim de avaliar quão bom é a receita da bebida</td>
    <td>S</td>
    <td>XX</td>
 </tr>

 <tr>
    <td>US09 - Eu, como usuário, desejo vizualizar os comentários á repeito de alguma bebida, a fim de saber a qualidade daquela receita</td>
    <td>S</td>
    <td>XX</td>
 </tr>

  <tr>
    <td>US10 - Eu, como usuário, desejo atualizar os comentários que eu cadastrei á respeito de alguma bebida, a fim de arrumar algo que escrevi errado</td>
    <td>S</td>
    <td>XX</td>
 </tr>

  <tr>
    <td>US11 - Eu, como usuário, desejo deletar meus comentários, a fim de não exibí-los na plataforma</td>
    <td>S</td>
    <td>XX</td>
 </tr>

  <tr>
    <td rowspan="2">F05 - Interagir com comentário</td>
    <td>US12 - Eu, como usuário, desejo cadastrar uma resposta à respeito de outro comentário já cadastrado, a fim de melhorar ajudar o usuário do comentário</td>
    <td>S</td>
    <td>XX</td>
 </tr>

  <tr>
    <td>US13 - Eu, como usuário, desejo reagir à algum comentário postado à respeito de alguma bebida, a fim de avaliar o quão é a receita postada</td>
    <td>M</td>
    <td>XX</td>
 </tr>
 ...
 <tr>
    <td rowspan="13">E03 - Bebidas</td>
    <td rowspan="2">F06 - Manter bebida</td>
 </tr>

 <tr>
    <td>US14 - Eu, como usuário, desejo vizualizar as informações de uma bebida</td>
    <td>M</td>
    <td>XX</td>
 </tr>

  <tr>
    <td rowspan="3">F07 - Procurar bebida</td>
    <td>US15 - Eu, como usuário, desejo pesquisar por uma bebida através de seu nome, para encontrá-la mais rápido</td>
    <td>S</td>
    <td>XX</td>
 </tr>

  <tr>
    <td>US16 - Eu, como usuário, desejo filtrar as bebidas com base em categoria, ingredientes e/ou popularidade, para encontrá-las mais rápido</td>
    <td>C</td>
    <td>XX</td>
 </tr>

  <tr>
    <td>US17 - Eu, como usuário, desejo ordenar a visualização de bebidas por ordem alfabética ou de popularidade, para encontrá-las mais rápido</td>
    <td>C</td>
    <td>XX</td>
 </tr>

  <tr>
    <td rowspan="3">F08 - Interagir com bebida</td>
    <td>US18 - Eu, como usuário, desejo poder curtir uma bebida, para ajudar a realçá-la na plataforma</td>
    <td>S</td>
    <td>XX</td>
 </tr>

  <tr>
    <td>US19 - Eu, como usuário, desejo poder favoritar uma bebida, para poder encontrá-la mais rapidamente no futuro</td>
    <td>S</td>
    <td>XX</td>
  </tr>

  <tr>
    <td>US20 - Eu, como usuário, desejo poder denunciar uma bebida, para alertar a plataforma de uma possível ofensa nas informações da bebida</td>
    <td>M</td>
    <td>XX</td>
  </tr>

  <tr>
    <td rowspan="2">F09 - Sortear bebida</td>
    <td>US21 - Eu, como usuário, desejo sortear uma bebida aleatória, para encontrar receitas sem procurá-las</td>
    <td>M</td>
    <td>XX</td>
 </tr>

  <tr>
    <td>US22 - Eu, como usuário, desejo filtrar o sorteio de uma bebida, para limitar os possíveis resutados</td>
    <td>S</td>
    <td>XX</td>
  </tr>

  <tr>
    <td rowspan="1">F10 - Submeter bebida</td>
    <td>US23 - Eu, como usuário, desejo submeter uma receita de bebida para a plataforma, a fim de ter minhas receitas publicadas no site</td>
    <td>M</td>
    <td>XX</td>
 </tr>
</table>
...
<!-- HEADER -->
 <tr>
  ...
  <tr>
   <td rowspan="2">E01 - Sessão de Usuário Administrador</td>
    <td rowspan="1">F01 - Autenticar usuário</td>
    <td>US01 - Eu, como usuário administrador, gostaria de autenticar com login e senha, para que eu possa acessar minha conta</td>
    <td>M</td>
    <td>XX</td>
 </tr>
  ...
  <tr>
    ...
    <td>US02 - Eu, como usuário administrador, gostaria de efetuar logout, para que possa sair da minha conta</td>
    <td>M</td>
    <td>XX</td>
 </tr>
 ...
 <tr>
    ...
    <td>US03 - Eu, como usuário administrador, gostaria de pesquisar alguma bebida da plataforma, para que posso acessar todas suas informações</td>
    <td>M</td>
    <td>XX</td>
 </tr>
 ...
 <tr>
  ...
  <tr>
    <td rowspan="2">F05 - Gerenciar usuários</td>
 ...
 <tr>
  ...
  <tr>
    ...
    <td>US09 - Eu, como administrador, gostaria de deletar comentários, para que possa tirar de site comentários que fogem do termo de serviço</td>
    <td>S</td>
    <td>XX</td>
 </tr>
  ...
  <tr>
    ...
    <td rowspan="3">F07 - Manter bebida</td>
