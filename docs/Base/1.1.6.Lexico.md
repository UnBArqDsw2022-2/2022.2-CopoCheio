...
<!-- LO00      | hotspots
----------|---
Sinônimos | "Pontos cruciais"
Noção     | Trechos de códigos mais prováveis de serem reutilizados ao longo do software
Impacto   | O hostpots são de grande importância para evitar a duplicidade do código

LO00      | frozenspots
----------|---
Sinônimos | Sem sinônimo
Noção     | Trechos de códigos menos prováveis de serem reutilizados ao longo do software
Impacto   |  -->
